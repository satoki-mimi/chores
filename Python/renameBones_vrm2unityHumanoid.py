...
def rename_bones():
  for bone in bpy.context.active_object.data.bones:
    if bone.name == 'Root': bone.name = 'Root' #Humanoidには不要
    ...
    elif bone.name == 'J_Sec_L_Bust2': bone.name = 'Bust2.L' #Humanoidには不要
    elif bone.name == 'J_Sec_R_Bust2': bone.name = 'Bust2.R' #Humanoidには不要
